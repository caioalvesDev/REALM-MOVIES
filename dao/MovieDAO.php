<?php
  ...
  class MovieDAO implements MovieDAOInterface {
    ...
    public function getMoviesByUserId($id): array {
    ...
    public function findById($id): object | bool {
    ...
    public function findByTitle($title): array {
      ...
      $stmt = $this->conn->prepare("SELECT DISTINCT * FROM movies
                                    WHERE LOWER(title) LIKE :title");
                                    

      $stmt->bindValue(":title", '%'.strtolower($title).'%');
